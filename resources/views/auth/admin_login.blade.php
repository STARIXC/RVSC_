...
<head>
  ...
  <body class="bg-light-gray" id="body">
            ...
            <div class="card-header bg-primary">
              <div class="app-brand">
                <a href="/">
                  ...
                  <span class="brand-name">RVSC ADMIN</span>
                </a>
              </div>
            </div>
      ...
      <div class="copyright pl-0">
        <p class="text-center">&copy; <?php echo date("Y")?> Rift Valley Sports Club  
          <a class="text-primary" href="http://www.starixc.co.ke" target="_blank">Starixc Tech Solutions</a>.
        </p>
