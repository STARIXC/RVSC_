...
?>
	...
	<head>
		<title>Rift Valley Sports Club | Add Events</title>
						...
						<h2>Add Facility</h2>
								...
								<div class="panel panel-widget forms-panel">
									<div class="forms">
										<div class="form-grids widget-shadow" data-example-id="basic-forms">
											...
											<div class="form-body">
												...
												<form method="post" action="actions/addevents.php" role="form" enctype="multipart/form-data" id="eventsform">
													...
													<button type="submit" class="btn btn-default" id="submit-event" name="submit-event">Add</button>
												</form>
											</div>
										</div>
									</div>
									<div class="alert alert-success alert-dismissible success_msg" role="alert">
										...
										<strong>Well done!</strong>Your details submitted Succesfully .
									</div>
