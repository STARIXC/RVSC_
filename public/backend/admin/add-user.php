...
if (strlen($_SESSION['hbmsaid'] == 0)) {
  ...
  if($query -> rowCount() == 0)
  {
  $sql="INSERT INTO tbladmin(AdminName, UserName, MobileNumber, Email, Password) Values(:aname,:title,:mobno,:email,:apassword)";
  $query = $dbh->prepare($sql);
  $query->bindParam(':aname',$name,PDO::PARAM_STR);
                                                ...
                                                <form method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                     <label for="exampleInputEmail1">Mobile Number</label>
                                                      <input type="text" class="form-control" name="mno" value="" required='true'/>
                                                       </div>
                                                       <div class="form-group">
