...
<html>
<head>
<title>Rift Valley Sports Club | Add Facility</title>
							...
							<div class="form-grids widget-shadow" data-example-id="basic-forms"> 
								...
								<div class="form-body">
									...
									<form method="post" enctype="multipart/form-data">
									 ...
									 <div class="form-group"> <label for="exampleInputEmail1">Service Title</label> <input type="text" class="form-control" name="ftitle" value="" required='true'> </div> 
