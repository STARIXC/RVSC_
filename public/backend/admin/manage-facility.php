...
{               ?>
                                    <tr>
                                        ...
                                        <td class="d-none d-sm-table-cell"><?php  echo htmlentities($row->Description);?></td>
                                         <td class="d-none d-sm-table-cell"><img src="images/services/<?php echo $row->Image;?>" width="100" height="100"></td>
                                        <td class="d-none d-sm-table-cell">
                                            <span class="badge badge-primary"><?php  echo htmlentities($row->CreationDate);?></span>
                                        </td>
                                         <td class="d-none d-sm-table-cell">

                                         	<a class="btn btn-info" href="edit-service.php?editid=<?php echo ($row->ID);?>">Edit</a>
                                         	<a class="btn btn-danger" href="manage-facility.php?delid=<?php echo ($row->ID);?>" onclick="return confirm('Do you really want to Delete ?');">Delete</a>
                                         </td>
                                    </tr>
                                    <?php $cnt=$cnt+1;}} ?> 
