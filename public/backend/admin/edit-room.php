...
{          
    ?>  
<option value="<?php echo htmlentities($row2->ID);?>"><?php echo htmlentities($row2->CategoryName);?>-<?php echo htmlentities($row2->Description);?></option>
 <?php } ?> 
...
<img src="images/roomimages/<?php echo $row->Image;?>" width="100" height="100" value="<?php  echo $row->Image;?>">
