...
<html>
<head>
<title>Rift Valley Sports Club | Add Media</title>
							...
							<div class="form-grids widget-shadow" data-example-id="basic-forms"> 
								...
								<div class="form-body">
									...
									<form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
									 ...
									 <div class="form-group">  <label for="exampleInputEmail1">Image Description</label> <input type="text" class="form-control" name="description" value="" required='true'> </div>
