...
<html>
<head>
<title>Rift Valley Sports Club  | Manage Room</title>
...
{               ?>
                                    <tr>
                                        ...
                                        <td class="d-none d-sm-table-cell"><?php  echo htmlentities($row->RoomDesc);?></td>
                                         <td class="d-none d-sm-table-cell"><img src="images/roomimages/<?php echo $row->Image;?>" width="100" height="100"></td>
                                        <td class="d-none d-sm-table-cell">
                                            <span class="badge badge-primary"><?php  echo htmlentities($row->CreationDate);?></span>
                                        </td>
                                         <td class="d-none d-sm-table-cell">
										 <a href="edit-room.php?editid=<?php echo ($row->ID);?>" class="btn  btn-primary">Edit</a>
										<!--  <a href="add-room-images.php?rid=<?php echo ($row->ID);?>"class="btn btn-success">Add Room Images</a>
										 <a href="view-room-images.php?rid=<?php echo ($row->ID);?>" class="btn btn-info">More ...</a>
										  --></td>
